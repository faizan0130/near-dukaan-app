...
const NewTransactionPage = () => {
    ...
    useEffect(() => {
        ...
        const fetchCustomers = async () => {
            ...
            try {
                ...
                if (urlCustomerId) {
                    const customer = data.find(c => c.id === urlCustomerId);
                    if (customer) {
                ...
                setError(err.message || 'Customer list load nahi ho payi');
            } finally {
    ...
    const finalAmount = paymentType === 'payment' 
                        ...
                        <Card className="shadow-sm border-slate-200">
                            {paymentType !== 'payment' ? (
                                ...
                                <CardContent className="pt-6">
                                    <div className="grid w-full items-center gap-1.5">
                                        <Label htmlFor="paymentAmount" className="text-slate-700 font-medium">
                                            Payment Amount
                                        </Label>
